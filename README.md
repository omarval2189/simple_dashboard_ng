...
```sh
$ git clone https://[user]@bitbucket.org/arizaga/telobusco-web.git
$ cd telobusco-web
...
Finally, open `file:///path/to/telobusco-web/build/index.html` in your browser.

Happy hacking!

## Purpose

`Te lo busco` is designed to make life easy by providing a basic framework
